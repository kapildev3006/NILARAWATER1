...
/// Central environment configuration for Nilara Delivery Partner App.
/// 
...
class EnvConfig {
  ...
  // Navigation & Maps
  static String get mapboxAccessToken => _get(
    'MAPBOX_ACCESS_TOKEN',
    defineValue: const String.fromEnvironment('MAPBOX_ACCESS_TOKEN', defaultValue: ''),
  );
